...
import { MobileBottomBar, TopNav } from "@/components/top-nav";
    ...
    <html lang="zh-CN" suppressHydrationWarning>
      ...
      >
        <AuthProvider>
          ...
          <main className="min-h-screen overflow-x-clip bg-stone-50 px-4 pt-0 pb-20 text-stone-900 dark:bg-stone-950 dark:text-stone-100 sm:px-6 sm:pt-2 sm:pb-2 lg:px-8">
